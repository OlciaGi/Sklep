    ...
    {           //migruje baze danych do najnowszej wersji, nie usuwajac danych wczesniej zapisanych
        public static void SeedKsiazkiData(KsiazkiContext context)
        {
            var kategorie = new List<Kategoria>
            {
                ...
                new Kategoria() {KategoriaId=8, NazwaKategorii="Podręczniki", NazwaPlikuIkony="podreczniki.png", OpisKategorii=" opis dla podreczniki"  },
                new Kategoria() {KategoriaId=9, NazwaKategorii="Naukowe", NazwaPlikuIkony="naukowe.png", OpisKategorii=" opis dla naukowe"  },
            };
            ...
            {
                new Ksiazka() { KsiazkaId = 1, AutorKsiazki="W. Bruce Cameron", TytulKsiazki=" Był sobie pies", KategoriaId=1, CenaKsiazki=24, Bestseller=false, NazwaPlikuObrazka ="bylsobiepies.png", DataDodania =DateTime.Now, OpisKsiazki = "Ksiązka, która doczekała się ekranizacji – przedstawia losy najbardziej wyszczekanego bohatera wszech czasów. Oto pełna głębokich uczuć i zdumiewająca opowieść o oddanym psie, który życiową misją czyni wpajanie swoim właścicielom znaczenia miłości i pogody ducha" },
